...
public class Digito extends Parent {
	private final boolean[][] DIGIT_COMBINATIONS = new boolean[][]{
	...
	public Digito(Color onColor, Color offColor, Effect onEffect, Effect offEffect) {
